...
direction_du_ventViewBase::direction_du_ventViewBase() :
    flexButtonCallback(this, &direction_du_ventViewBase::flexButtonCallbackHandler)
{
...
void direction_du_ventViewBase::setupScreen()
{

}

void direction_du_ventViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &flexButton1)
    {
        //Interaction1
